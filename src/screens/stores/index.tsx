    ...
    return(
        <div className="py-6">
            ...
            <div className="sm:flex-col md:flex-row flex flex-wrap gap-4 sm:justify-center md:justify-start py-4">
                {stores.map((store)=><StoreCard image_url={store.logo} name={store.store_name} onClick={handleOnStoreClick}/>)}
                <Card className="bg-muted/90 rounded-xl sm:w-full md:w-52 cursor-pointer hover:brightness-50" onClick={handleAddStore}>
