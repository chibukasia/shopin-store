...
const StoreCard = (props: StoreCardProps) => {
    return(
        <Card className="bg-white rounded-xl sm-w-full md:w-52 cursor-pointer hover:brightness-90" onClick={props.onClick}>
            ...
            <div className="flex items-center justify-start px-2 bg-primary rounded-b-xl">
